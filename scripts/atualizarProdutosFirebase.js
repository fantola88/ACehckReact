...
// IMPORTANTE: Substitua pelos seus dados reais do Firebase
  ...
  const firebaseConfig = {
    ...
    authDomain: process.env.FIREBASE_AUTH_DOMAIN || "SEU_AUTH_DOMAIN_AQUI",
    databaseURL: process.env.FIREBASE_DATABASE_URL || "SEU_DATABASE_URL_AQUI",
    projectId: process.env.FIREBASE_PROJECT_ID || "SEU_PROJECT_ID_AQUI",
    storageBucket: process.env.FIREBASE_STORAGE_BUCKET || "SEU_STORAGE_BUCKET_AQUI",
    messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || "SEU_SENDER_ID_AQUI",
    appId: process.env.FIREBASE_APP_ID || "SEU_APP_ID_AQUI"
  };
